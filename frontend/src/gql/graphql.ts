...
export type GetBlogsQuery = { __typename?: 'Query', blogs: Array<{ __typename?: 'Blog', _id: string, title: string, blogImage: string, blogContent: string, blogCategory: string, createdAt: string, likeCount: number, user: { __typename?: 'User', _id: string, firstName: string, lastName?: string | null } }> };
