...
export type GetBlogQuery = { __typename?: 'Query', blog?: { __typename?: 'Blog', _id: string, title: string, blogImage: string, blogContent: string, blogCategory: string, createdAt: string, user: { __typename?: 'User', _id: string, firstName: string, lastName?: string | null, email: string, profilePicture: string } } | null };
...
export type BlogsByCategoryQuery = { __typename?: 'Query', blogsByCategory?: Array<{ __typename?: 'Blog', _id: string, title: string, blogImage: string, blogContent: string, blogCategory: string, user: { __typename?: 'User', _id: string, firstName: string, lastName?: string | null } } | null> | null };
